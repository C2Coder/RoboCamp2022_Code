...
try:
    ...
    print(f'Usage ./2048.py <port> <baud>')
    print(f'Example: ./2048.py /dev/ttyACM0 115200')
    exit()
...
class Game:
    ...
    def __init__(self, board):
        ...
        self.screen = pygame.display.set_mode((SCREEN_WIDTH*2.1, SCREEN_HEIGHT))
...
def main():
    ...
    # Initialize pygame
    pygame.init()
    pygame.display.set_caption('MicroBit plays 2048')
    pygame.font.init()
    ...
    #with serial.Serial("COM47", 115200, timeout=0) as ser:
